...
- Generally, before developing enhancements to this repository, you should consider [opening an issue
  ](https://github.com/canonical/repo-policy-compliance/issues) explaining your use case.
...
adding an entry to the [CHANGELOG.md](https://github.com/canonical/repo-policy-compliance/blob/main/CHANGELOG.md) file.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/repo-policy-compliance)
...
```
git clone https://github.com/canonical/repo-policy-compliance.git
```
...
OCI image for the `repo-policy-compliance` app, and then upload the image to a MicroK8s registry,
